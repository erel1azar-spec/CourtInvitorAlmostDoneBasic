...
namespace CourtReserve.Models
{
    internal class Strings
    {
        ...
        public const string SelectRoleTitle = "Select Role";
        ...
        public const string PasswordEmpty = "Please enter your password";
        public const string RoleNotSelected = "Please select a role (Client or Admin)";
        ...
        public const string MakeReservationText = "Make Reservation";
        public const string PlayerSearchText = "Player Search";
        public const string MyReservationsText = "My Reservations";
        public const string ProfileText = "Profile";
        public const string RecievedSuggestionsText = "Recieved Suggestions";
        ...
        public const string LoginTitle = "Login to CourtReserve!";
        public const string RegisterTitle = "Register to CourtReserve!";
        ...
        public const string ClubNameLabel = "Club Name";
        public const string LocationLabel = "Location";
        public const string PhoneLabel = "Phone";
        public const string EmailLabel = "Email";
        public const string CourtsCountLabel = "Courts Count";
        public const string SaveClubButton = "Save Club";
        public const string ClubNameEmpty = "Club name cannot be empty.";
        public const string ClubAlreadyExists = "Club already exists!";
        public const string ClubCreatedSuccess = "Club created successfully!";
        public const string LocationEmpty = "Location cannot be empty.";
        public const string PhoneEmpty = "Phone cannot be empty.";
        public const string PhoneInvalid = "Phone must contain only digits.";
        public const string ClubEmailEmpty = "Email cannot be empty.";
        public const string ClubEmailInvalid = "Email format is invalid.";
        public const string NotLoggedIn = "Please login before creating a club.";
        public const string SignOut = "Sign Out";
        public const string FilterByDate = "Select Date";
        public const string FilterByHour = "Select Hour";
        public const string FilterButton = "Filter";
        public const string ShowAllButton = "Show All";
    }
}
